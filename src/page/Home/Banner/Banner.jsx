        ...
        <div className="w-3/5">
          ...
          >
            ...
            <div id="slide3" className="carousel-item relative w-full">
              ...
              <div className="absolute rounded-xl h-full flex items-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)">
                <div className="text-white space-y-7 w-1/2 pl-16">
                  ...
                  <p>
                    Wellness in Focus: From groundbreaking medical discoveries
                    to holistic health practices, stay informed about the latest
            ...
            <div id="slide4" className="carousel-item relative w-full">
              ...
              <div className="absolute rounded-xl h-full flex items-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)">
                <div className="text-white space-y-7 w-1/2 pl-16">
                  <h1 className="text-6xl font-bold">Financial Frontiers</h1>
                  <p>
                    Navigating the Markets: Comprehensive coverage of global
                    financial news, market trends, and economic insights to keep
                    you ahead in the world of finance.
                  </p>
                  <div>
                    <button className="btn btn-active bg-red-500 border-none text-white mr-5">
                      Discover
              ...
              <div className="absolute rounded-xl h-full flex items-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)">
                <div className="text-white space-y-7 w-1/2 pl-16">
                  ...
                  <p>
                    ...
                    culture with a focus on the latest in art, cinema, music,
                    and literature, capturing the pulse of creativity around the
                    globe.
                  </p>
                  <div>
                    <button className="btn btn-active bg-red-500 border-none text-white mr-5">
            ...
            <div id="slide6" className="carousel-item relative w-full">
              ...
              <div className="absolute rounded-xl h-full flex items-center left-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)">
                <div className="text-white space-y-7 w-1/2 pl-16">
                  ...
                  <p>
                    International Affairs Unfold: A closer look at geopolitical
                    events, diplomatic developments, and global issues that are
